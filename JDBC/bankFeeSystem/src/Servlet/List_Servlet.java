    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            try {
                ...
                CallableStatement cs = conn.prepareCall("{call PACKAGE_POWER_RATE_LIST_CURSOR.QUERY_LIST_BY_CUSTOMER_ID(?,?)}");
                cs.setObject(1, UID);
                ...
                while(rSet.next()){
                    ...
                    jsonArray1.put(rSet.getString(9));
                    jsonArray1.put(rSet.getString(10));
                    jsonArray1.put(rSet.getString(11));
                    jsonArray1.put(rSet.getString(12));
                    jsonArray1.put(rSet.getString(13));
                    jsonArray1.put(rSet.getString(14));
                    jsonArray1.put(rSet.getString(15));
                    jsonArray1.put(rSet.getString(16));
            ...
            res.addProperty("list", String.valueOf(jsonArray));
            out.print(res);
            out.flush();
            out.close();
        } catch (Exception e) {
